...
.create "extract\2447C4_m.bin", 0 :: .org 0 :: .import "jetters.gba", 0x2447C4, 4096 :: .close; m087
...
.create "extract\StoryMiniMap.bin", 0 :: .org 0 :: .import "jetters.gba", 0x2631F8, 0x100 :: .close; m128
...
.create "extract\5CCE0_p.bin", 0 :: .org 0 :: .import "jetters.gba", 0x5CCE0, 0x80 :: .close; p84
.create "extract\StoryMini_Pal.bin", 0 :: .org 0 :: .import "jetters.gba", 0x2625E4, 0x20 :: .close; p85
...
; BATTLE FONT EXTRACTION
; Extract the Battle Font Palette (32 Bytes / 16 Colors)
.create "extract\FontBattle_Palette.bin", 0
.org 0
.import "jetters.gba", 0x1B5258, 0x20 
.close

; Extract the Battle Font Graphics
.create "extract\FontBattle.bin", 0
.org 0
.import "jetters.gba", 0x1B5278, 0x2000
.close
