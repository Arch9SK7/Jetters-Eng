...
tools\gbamdc.exe -e jetters.gba extract\BattleTileSprite_p.bin 5E494
tools\G3 extract\BattleTileSprite_p.bin extract\BattleTileSprite_m.bin extract\BattleTileSprite_t.bin 32 4 extract\BattleTileSprite.bmp
...
:: Main Title Screen Art (8bpp Background)
tools\E8 extract\2411A4_p.bin extract\2447C4_m.bin extract\241384_t.bin 30 40 extract\241384.bmp
:: Title Screen Secondary Layer (4bpp Background)
tools\G3 extract\245124_p.bin extract\245254_m.bin extract\245144_t.bin 30 20 extract\245144.bmp
:: Title Screen Menu Buttons (4bpp SPRITES - No Map!)
tools\R4 extract\245704_p.bin extract\245784_t.bin 32 extract\245784.bmp

:: MP CART
:: Extract the compressed graphics
tools\gbamdc.exe -e jetters.gba extract\CartModesTile.bin 19E914
python tools\dump_raw.py jetters.gba extract\CartModesPal.bin 19E714 200
python tools\dump_raw.py jetters.gba extract\CartModesMap.bin 19F858 800
python tools\build_map.py extract\CartModesPal.bin extract\CartModesTile.bin extract\CartModesMap.bin
...
tools\G3 extract\BHallBoard_p.bin extract\BHallBoard_Ranks_m.bin extract\BHallBoard_t.bin 2 28 extract\BHallBoard_Ranks.bmp
...
tools\R4 extract\FontBattle_Palette.bin extract\BattleTileBGText.bin 16 extract\FontBattle_Clean.bmp

:: Mini games Ready, start, clear
python tools\dump_raw.py jetters.gba extract\MPText_Pal.bin 5CCE0 200
tools\gbamdc.exe -e jetters.gba extract\MPText_Tiles.bin B543C
tools\R4 extract\MPText_Pal.bin extract\MPText_Tiles.bin 32 extract\MPText.bmp
python tools\dump_raw.py jetters.gba extract\MPClear_Pal.bin B58B0 200
tools\gbamdc.exe -e jetters.gba extract\MPClear_Tiles.bin B59E4
tools\R4 extract\MPClear_Pal.bin extract\MPClear_Tiles.bin 32 extract\MPClear.bmp

:: Debug mini games/real mini games Hurry!, Time Up, Draw
python tools\dump_raw.py jetters.gba extract\DebugHurry_Pal.bin 5D6A4 200
tools\gbamdc.exe -e jetters.gba extract\DebugHurry_Tiles.bin 1ACBD8
tools\R4 extract\DebugHurry_Pal.bin extract\DebugHurry_Tiles.bin 32 extract\DebugHurry.bmp

python tools\dump_raw.py jetters.gba extract\DebugTimeup_Pal.bin 5D944 200
tools\gbamdc.exe -e jetters.gba extract\DebugTimeup_Tiles.bin 1ACEE0
tools\R4 extract\DebugTimeup_Pal.bin extract\DebugTimeup_Tiles.bin 32 extract\DebugTimeup.bmp

python tools\dump_raw.py jetters.gba extract\DebugDraw_Pal.bin 617A0 200
tools\gbamdc.exe -e jetters.gba extract\DebugDraw_Tiles.bin 1AF9C0
tools\R4 extract\DebugDraw_Pal.bin extract\DebugDraw_Tiles.bin 32 extract\DebugDraw.bmp

:: Cub Race Start, Goal, Win, Lose + Score/Time
python tools\dump_raw.py jetters.gba extract\CubRace_Pal.bin F11A4 200
tools\gbamdc.exe -e jetters.gba extract\CubRace_Tiles.bin F1AD4
tools\R4 extract\CubRace_Pal.bin extract\CubRace_Tiles.bin 32 extract\CubRace.bmp

python tools\dump_raw.py jetters.gba extract\CubScoreTime_Pal.bin 1D9D6C 20
tools\gbamdc.exe -e jetters.gba extract\CubScoreTime_Tiles.bin 1D9950
tools\R4 extract\CubScoreTime_Pal.bin extract\CubScoreTime_Tiles.bin 32 extract\CubScoreTime.bmp

:: Story Mujoe Mini game score/time
python tools\dump_raw.py jetters.gba extract\StoryMini_Pal.bin 262DE0 200
...
tools\R4 extract\EndCred_Pal.bin extract\EndCred_Tiles.bin 32 extract\EndCred.bmp
pause